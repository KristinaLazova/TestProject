...
public class SampleExperiment {
    ...
    public void runExperiment() {
        ...
        System.out.println("Telling the environment to use fixed start state of 2,1.");
        RLGlue.RL_env_message("set-start-state 2 1");
        ...
        System.out.println("Evaluating the agent a few times from a fixed start state of 2,1:\n\t\tMean Return\tStandardDeviation\n-------------------------------------------");
        thisScore=evaluateAgent();
        printScore(0, thisScore);
